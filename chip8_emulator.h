 ...
 *
 * @param windowTitle
 *               New window title to be set. For maximum length, @see chip8_global.h CHIP8_SCREEN_TITLE_MAXLEN
 */
 ...
 * @see chip8_public.h the EMU_QUIRK_ numerics for possible quirks
 * @param quirks All Quriks ORed together which should be enabled (others will be disabled)
 */
