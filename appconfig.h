...
{
  /**
   * No Error, function was successfully
   */
  APPCFG_ERR_NONE,
  /**
...
/**
 * Creates a new config datastructure object.
 *
 ...
 */
extern int appConfig_New(AppConfig *config,
 ...
 *
 * @param config _IN_ The config, created by calling appConfig_New()
 */
 ...
 */
extern int appConfig_DataDelete(const AppConfig config);
