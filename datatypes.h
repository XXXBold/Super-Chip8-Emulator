...
typedef enum
{
  ...
  eDataRepresentation_Int_Decimal     =0x100,
  eDataRepresentation_Int_Binary      =0x200,
  eDataRepresentation_Int_Octal       =0x400,
  eDataRepresentation_Int_Hexadecimal =0x800,
  eDataRepresentation_Int_Default     =eDataRepresentation_Int_Decimal,
}EDataType;
                             ...
                             EDataType eDataRepresentation)
{
  ...
  if(!eDataRepresentation) /* If Data representation was not set, set to default */
    eDataRepresentation=eDataRepresentation_Int_Default;
  ptagData->eType=(eDataType_Int | eDataRepresentation);
                              ...
                              EDataType eDataRepresentation)
{
  ...
  if(!eDataRepresentation) /* If Data representation was not set, set to default */
    eDataRepresentation=eDataRepresentation_Int_Default;
  ptagData->eType=(eDataType_Uint | eDataRepresentation);
                                ...
                                double dVal)
{
  ...
  ptagData->eType=eDataType_Double;
                                 ...
                                 int bVal)
{
  ...
  ptagData->eType=eDataType_Boolean;
  ptagData->uiDataSizeMax=sizeof(int);
  ptagData->uiDataSizeUsed=sizeof(int);
}
                               ...
                               unsigned int uiDataLength)
{
  ...
  ptagData->eType=eDataType_String;
  if(pcVal)
  {
                               ...
                               unsigned int uiDataLength)
{
  ...
  ptagData->eType=eDataType_Binary;
  if(pucVal)
  {
